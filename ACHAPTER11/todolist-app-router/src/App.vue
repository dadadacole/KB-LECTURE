...
const states = reactive({
    todoList: [
        ...
        { id: 2, todo: 'ES6학습', desc: '설명1', done: false },
        { id: 3, todo: 'ES6학습', desc: '설명1', done: true },
        { id: 4, todo: 'ES6학습', desc: '설명1', done: false },
    ],
});
...
const toggleDone = (id) => {
    let index = states.toodoList.findIndex((todo) => todo.id === id);
